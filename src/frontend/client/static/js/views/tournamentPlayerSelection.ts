...
export default class PlayerSelection extends AbstractView {
  ...
  async getPlayerCard(playerId:number, container: HTMLElement) {
    ...
    playerCard.className = 'col-3 w-34 h-40 player border-8 border-white/10 text-black p-4 rounded-xl flex flex-col items-center cursor-pointer hover:scale-105 transition-all duration-200';
